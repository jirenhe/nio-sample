package com.wanshifu.transformers.common.statistics;
...
public class VMInfo {
    ...
    private static final VMInfo vmInfo = new VMInfo();
    ...
    private VMInfo() {
        ...
        if (!memoryPoolMXBeanList.isEmpty()) {
    ...
    public String toString() {
        return "the machine monitorInfo  => \n\n"
                + "\tosInfo:\t" + osInfo + "\n"
                + "\tjvmInfo:\t" + jvmInfo + "\n"
    ...
    public synchronized String getDelta() {
        ...
        try {
            ...
            return (processCpuStatus.getDeltaString() + processMomoryStatus.getDeltaString() + processGCStatus.getDeltaString());
