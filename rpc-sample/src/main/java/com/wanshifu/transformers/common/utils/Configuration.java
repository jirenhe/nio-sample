 ...
 * configuration.getString("core.container.channel.class"); <br>
 * <p/>
 * <br>
 * 设置多级List <br>
 * configuration.set("channel.reader.parameter.jdbcUrl", Arrays.asList(new String[]
 * {"jdbc", "jdbc"}));
 * <p/>
 * <p/>
 * <br>
...
public class Configuration {
     ...
     * 初始化空白的Configuration
     */
    public static Configuration newDefault() throws ConfigurationException {
     ...
     */
    public static Configuration from(String json) throws ConfigurationException {
        json = StringUtils.replaceVariable(json);
        checkJSON(json);
     ...
     */
    public static Configuration from(File file) throws ConfigurationException {
        try {
            return Configuration.from(IOUtils
                    .toString(new FileInputStream(file), StandardCharsets.UTF_8));
        } catch (FileNotFoundException e) {
            throw new ConfigurationException(String.format("配置信息错误，您提供的配置文件[%s]不存在. 请检查您的配置文件.",
                    file.getAbsolutePath()), e);
        } catch (IOException e) {
            throw new ConfigurationException(String.format("配置信息错误. 您提供配置文件[%s]读取失败，请检查您的配置文件的权限设置.",
                    file.getAbsolutePath()), e);
        }
    }
     ...
     */
    public static Configuration from(InputStream is) throws ConfigurationException {
        try {
            return Configuration.from(IOUtils.toString(is, StandardCharsets.UTF_8));
        } catch (IOException e) {
            throw new ConfigurationException("配置信息错误. 您提供配置文件读取失败，请检查您的配置文件的权限设置.", e);
        }
    }
     ...
     */
    public static Configuration from(final Map<String, Object> object) throws ConfigurationException {
     ...
     */
    public static Configuration from(final List<Object> object) throws ConfigurationException {
        return Configuration.from(Configuration.toJSONString(object));
    }

    public String getNecessaryValue(String key) throws ConfigurationException {
        String value = this.getString(key, null);
        if (StringUtils.isBlank(value)) {
            throw new ConfigurationException(String.format("您提供配置文件有误，[%s]是必填参数，不允许为空或者留白 .", key));
        }
    ...
    public Boolean getNecessaryBool(String key) throws ConfigurationException {
     ...
     */
    public Configuration getNecessaryConfiguration(final String path) throws ConfigurationException {
        Configuration configuration = this.getConfiguration(path);
        if (null == configuration) {
            throw new ConfigurationException(String.format("您提供配置文件有误，[%s]是必填参数，不允许为空或者留白 .", path));
        }
     ...
     * 如果path获取的路径或者对象不存在，返回null
     */
    public Configuration getConfiguration(final String path) throws ConfigurationException {
     ...
     */
    public Character getChar(final String path) throws ConfigurationException {
        String result = this.getString(path);
        if (null == result) {
            return null;
        }
        ...
        try {
            ...
            throw new ConfigurationException(String.format("任务读取配置文件出错. 因为配置文件路径[%s] 值非法，期望是字符类型: %s. 请检查您的配置并作出修改.", path,
                    e.getMessage()), e);
        }
    }
     ...
     */
    public Character getChar(final String path, char defaultValue) throws ConfigurationException {
     ...
     */
    public Boolean getBool(final String path) throws ConfigurationException {
        String result = this.getString(path);
        ...
        if (null == result) {
            ...
            throw new ConfigurationException(String.format("您提供的配置信息有误，因为从[%s]获取的值[%s]无法转换为bool类型. 请检查源表的配置并且做出相应的修改.",
                    path, result));
        }
     ...
     */
    public Boolean getBool(final String path, boolean defaultValue) throws ConfigurationException {
     ...
     */
    public Integer getInt(final String path) throws ConfigurationException {
        String result = this.getString(path);
        if (null == result) {
            return null;
        }
        ...
        try {
            ...
            throw new ConfigurationException(String.format("任务读取配置文件出错. 配置文件路径[%s] 值非法, 期望是整数类型: %s. 请检查您的配置并作出修改.", path,
                    e.getMessage()), e);
        }
    }
     ...
     */
    public Integer getInt(final String path, int defaultValue) throws ConfigurationException {
    ...
    public Integer getNecessaryInt(final String path) throws ConfigurationException {
        String result = this.getNecessaryValue(path);
        try {
            return Integer.valueOf(result);
        } catch (Exception e) {
            throw new ConfigurationException(String.format("任务读取配置文件出错. 配置文件路径[%s] 值非法, 期望是整数类型: %s. 请检查您的配置并作出修改.", path,
     ...
     */
    public Long getLong(final String path) throws ConfigurationException {
        String result = this.getString(path);
     ...
     */
    public Long getLong(final String path, long defaultValue) throws ConfigurationException {
    ...
    public Long getNecessaryLong(final String path) throws ConfigurationException {
        String result = this.getNecessaryValue(path);
        try {
            return Long.valueOf(result);
        } catch (Exception e) {
     ...
     */
    public Double getDouble(final String path) throws ConfigurationException {
        String result = this.getString(path);
        if (StringUtils.isBlank(result)) {
            return null;
        }
        ...
        try {
            ...
            throw new ConfigurationException(String.format("任务读取配置文件出错. 配置文件路径[%s] 值非法, 期望是浮点类型: %s. 请检查您的配置并作出修改.", path,
                    e.getMessage()), e);
        }
    }
     ...
     */
    public Double getDouble(final String path, double defaultValue) throws ConfigurationException {
    ...
    public <T> List<T> getNecessaryList(final String path) throws ConfigurationException {
        List<T> list = this.getList(path);
    ...
    public <T> List<T> getList(final String path) {
        List<Object> object = this.get(path);
        if (null == object) {
     ...
     */
    public List<Configuration> getListConfiguration(final String path) throws ConfigurationException {
    ...
    public <T> Map<String, T> getMap(final String path) {
        Map<String, Object> map = this.get(path);
        if (null == map) {
    ...
    public <T> Map<String, T> getMap(final String path,
        ...
        Map<String, T> result = getMap(path);
        if (null == result) {
            return defaultMap;
        }
        return result;
     ...
     */
    @SuppressWarnings("unchecked")
    public Map<String, Configuration> getMapConfiguration(final String path) throws ConfigurationException {
        Map<String, Object> map = this.get(path);
        if (null == map) {
            return Collections.emptyMap();
        }
     ...
     */
    public Object set(final String path, final Object object) throws ConfigurationException {
        checkPath(path);
     ...
     */
    public Object remove(final String path) throws ConfigurationException {
    ...
    public Configuration merge(final Configuration another,
                               boolean updateWhenConflict) throws ConfigurationException {
    ...
    public String toJSON(boolean prettyFormat) {
        return Configuration.toJSONString(this.getInternal(), prettyFormat);
    }
    ...
    private void setObject(final String path, final Object object) throws ConfigurationException {
    ...
    private Object buildObject(final List<String> paths, final Object object) throws ConfigurationException {
        if (null == paths) {
            throw new ConfigurationException();
        }
    ...
    private Object setObjectRecursive(Object current, final List<String> paths,
                                      int index, final Object value) throws ConfigurationException {
    ...
    private static void checkJSON(final String json) throws ConfigurationException {
    ...
    private Configuration(final String json) throws ConfigurationException {
        try {
    ...
    private static String toJSONString(final Object object, boolean prettyFormat) {
